...
USER_INFO_THEME_PROMPT_COLOR=54 #90
USER_INFO_THEME_PROMPT_COLOR_SUDO=200

PYTHON_VENV_CHAR=${POWERLINE_PYTHON_VENV_CHAR:="❲p❳ "}
CONDA_PYTHON_VENV_CHAR=${POWERLINE_CONDA_PYTHON_VENV_CHAR:="❲c❳ "}
PYTHON_VENV_THEME_PROMPT_COLOR=91

SCM_NONE_CHAR=""
SCM_GIT_CHAR=${POWERLINE_SCM_GIT_CHAR:=" "}
SCM_THEME_PROMPT_CLEAN=""
SCM_THEME_PROMPT_DIRTY=""
SCM_THEME_PROMPT_CLEAN_COLOR=54
SCM_THEME_PROMPT_DIRTY_COLOR=92
SCM_THEME_PROMPT_STAGED_COLOR=69
SCM_THEME_PROMPT_UNSTAGED_COLOR=24 #52
...
CWD_THEME_PROMPT_COLOR=90

LAST_STATUS_THEME_PROMPT_COLOR=196

CLOCK_THEME_PROMPT_COLOR=90 #54
